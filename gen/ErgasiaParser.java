...
public class ErgasiaParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ErgasiaListener ) ((ErgasiaListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ErgasiaListener ) ((ErgasiaListener)listener).exitProg(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ErgasiaVisitor ) return ((ErgasiaVisitor<? extends T>)visitor).visitProg(this);
	...
	public static class StatContext extends ParserRuleContext {
		...
		public TerminalNode NEWLINE() { return getToken(ErgasiaParser.NEWLINE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ErgasiaListener ) ((ErgasiaListener)listener).enterStat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ErgasiaListener ) ((ErgasiaListener)listener).exitStat(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ErgasiaVisitor ) return ((ErgasiaVisitor<? extends T>)visitor).visitStat(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(ErgasiaParser.INT, 0); }
		public TerminalNode ID() { return getToken(ErgasiaParser.ID, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ErgasiaListener ) ((ErgasiaListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ErgasiaListener ) ((ErgasiaListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ErgasiaVisitor ) return ((ErgasiaVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
